...
export function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white p-5 shadow-[var(--shadow-card)] ring-1 ring-slate-200 transition duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-pop)]">
